...
describe('Legacy token payment wrapper', () => {
  describe('POST /api/v1/overlay/:merchantId/payment/open/token', _ => {
    it('with empty payment', done => {
      ...
      chai
        .request(server)
        .post('/api/v1/overlay/375917/payment/open/token')
        .send(payment)
        .end((error, response) => {
          // TODO fix the test to be a proper test once we start implementing token payment.
